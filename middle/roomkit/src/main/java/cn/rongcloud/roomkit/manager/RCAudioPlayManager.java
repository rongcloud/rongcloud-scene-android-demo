                    ...
                    try {
                        ...
                        if (!isHeadphonesPlugged(mAudioManager)) {
                            ...
                            if (_sensorManager != null) {
                                ...
                                _sensorManager.registerListener(RCAudioPlayManager.this, _sensor, SensorManager.SENSOR_DELAY_NORMAL);
                            }
                        }
...
//                mMediaPlayer.setDataSource(context, Uri.parse(audioUri.toString()));
    ...
    static class SingletonHolder {
        static RCAudioPlayManager sInstance = new RCAudioPlayManager();
    }
}
