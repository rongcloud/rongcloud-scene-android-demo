...
public class UserProvider implements IProvider<UserInfo> {
    ...
    @Override
    public void getAsyn(@NonNull String key, IResultBack<UserInfo> resultBack) {
    ...
    @Override
    public void observeSingle(@NonNull String key, @NonNull IResultBack<UserInfo> resultBack) {
    ...
    @Override
    public void provideFromService(@NonNull List<String> ids, @Nullable IResultBack<List<UserInfo>> resultBack) {
