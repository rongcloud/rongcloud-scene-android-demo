package cn.rongcloud.beauty.seekbar.internal.drawable;
...
public class AlmostRippleDrawable extends StateDrawable implements Animatable {
    ...
    public void setColor(@NonNull ColorStateList tintStateList) {
        ...
        mDisabledColor =
                tintStateList.getColorForState(
                        new int[]{-android.R.attr.state_enabled}, defaultColor);
    ...
    public void animateToPressed() {
        ...
        if (mCurrentScale < ACTIVE_SCALE) {
            ...
            float durationFactor =
                    1f
                            - ((mAnimationInitialValue - INACTIVE_SCALE)
    ...
    public void animateToNormal() {
        ...
        if (mCurrentScale > INACTIVE_SCALE) {
            ...
            float durationFactor =
                    1f
                            - ((mAnimationInitialValue - ACTIVE_SCALE)
    ...
    private final Runnable mUpdater =
            new Runnable() {
                ...
                public void run() {
                    ...
                    if (diff < mDuration) {
                        float interpolation =
                                mInterpolator.getInterpolation((float) diff / (float) mDuration);
