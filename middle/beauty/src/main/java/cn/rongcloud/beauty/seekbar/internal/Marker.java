...
public class Marker extends ViewGroup implements MarkerDrawable.MarkerAnimationListener {
    ...
    public Marker(
        ...
        // as we're reading the parent DiscreteSeekBar attributes, it may wrongly set this view's
        // visibility.
    ...
    public void resetSizes(String maxValue) {
        ...
        // Account for negative numbers... is there any proper way of getting the biggest string
        // between our range????
        mNumber.setText("-" + maxValue);
