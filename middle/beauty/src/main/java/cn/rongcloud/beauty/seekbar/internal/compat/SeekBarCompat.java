package cn.rongcloud.beauty.seekbar.internal.compat;
...
import cn.rongcloud.beauty.seekbar.internal.drawable.AlmostRippleDrawable;
...
public class SeekBarCompat {
    ...
    /**
     * Our DiscreteSeekBar implementation uses a circular drawable on API < 21 because we don't set
     * it as Background, but draw it ourselves
     *
