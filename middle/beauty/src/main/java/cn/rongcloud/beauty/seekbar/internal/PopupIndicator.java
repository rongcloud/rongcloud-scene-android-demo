package cn.rongcloud.beauty.seekbar.internal;
...
public class PopupIndicator {
    ...
    private class Floater extends FrameLayout implements MarkerDrawable.MarkerAnimationListener {
        ...
        protected void onLayout(boolean changed, int l, int t, int r, int b) {
            ...
            mMarker.layout(
                    offset, 0, offset + mMarker.getMeasuredWidth(), mMarker.getMeasuredHeight());
        }
        ...
        public void setFloatOffset(int x) {
            ...
            // Without hardware acceleration (or API levels<11), offsetting a view seems to NOT
            // invalidate the proper area.
