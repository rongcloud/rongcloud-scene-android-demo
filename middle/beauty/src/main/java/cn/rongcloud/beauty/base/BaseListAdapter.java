package cn.rongcloud.beauty.base;
...
import cn.rongcloud.beauty.listener.OnMultiClickListener;
...
public class BaseListAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseListAdapter(
            List<T> data, BaseDelegate<T> viewHolderDelegate, int... resLayouts) {
        mLayouts = resLayouts;
        this.data = data;
        ...
        view.setOnLongClickListener(
                v ->
                        viewHolderDelegate.onItemLongClickListener(
                                view, data.get(position), position));
    }
