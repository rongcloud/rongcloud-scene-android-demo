 ...
 * <p>
 *
 * <p>This will work like {@link android.support.v4.view.ViewPropertyAnimatorCompat}, that is, not
 * doing anything on API<11 and using the default {@link android.animation.ValueAnimator} on API>=11
 *
