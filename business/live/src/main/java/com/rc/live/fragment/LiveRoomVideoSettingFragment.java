 ...
 * @date 2021/11/19
 */
public class LiveRoomVideoSettingFragment extends BaseBottomSheetDialog {
    ...
    public LiveRoomVideoSettingFragment(String resolution, String fps, OnVideoConfigSetting onVideoConfigSetting) {
