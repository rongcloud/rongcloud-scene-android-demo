...
public class SightMessageAttachedInfo extends BaseMessageAttachedInfo {

    @Override
    public String onSetObjectName() {
        return ObjectName.Sight_TAG;
    }
    ...
    public void onConvert(RcyHolder holder, WrapperMessage item, int position) {
        ...
        //长按视频，直接调用最外层的长按方法
        holder.setOnLongClickListener(R.id.iv_play_id, new View.OnLongClickListener() {
            @Override
