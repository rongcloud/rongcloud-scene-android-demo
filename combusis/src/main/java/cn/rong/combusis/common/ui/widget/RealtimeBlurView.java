...
public class RealtimeBlurView extends View {
    ...
    public RealtimeBlurView(Context context, AttributeSet attrs) {
        ...
        radius = a.getDimensionPixelOffset(R.styleable.RealtimeBlurView_radius, 0);
        leftTopRadius = a.getDimensionPixelOffset(R.styleable.RealtimeBlurView_left_top_radius, 0);
        rightTopRadius = a.getDimensionPixelOffset(R.styleable.RealtimeBlurView_right_top_radius, 0);
        rightBottomRadius = a.getDimensionPixelOffset(R.styleable.RealtimeBlurView_right_bottom_radius, 0);
        leftBottomRadius = a.getDimensionPixelOffset(R.styleable.RealtimeBlurView_left_bottom_radius, 0);
