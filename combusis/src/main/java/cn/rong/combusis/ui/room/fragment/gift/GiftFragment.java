 ...
 * @date 2021/10/9
 */
public class GiftFragment extends BaseBottomSheetDialogFragment {
    ...
    private void sendGiftMessage(List<Member> members, boolean isAll) {
        ...
        if (isAll) {
            ...
            all.setUserId(AccountStore.INSTANCE.getUserId());
            all.setUserName(AccountStore.INSTANCE.getUserName());
            ...
            for (Member member : members) {
                ...
                gift.setUserId(AccountStore.INSTANCE.getUserId());
                gift.setUserName(AccountStore.INSTANCE.getUserName());
    ...
    private void updateBtnNum(Boolean showPop) {
        ...
        mBtnNum.setCompoundDrawablePadding(UiUtils.INSTANCE.dp2Px(requireContext(), 1f));
    }
