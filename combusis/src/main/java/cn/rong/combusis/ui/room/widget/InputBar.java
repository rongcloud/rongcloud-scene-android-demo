...
public class InputBar extends LinearLayout {
    ...
    public void initView() {
        ...
        this.setMinimumHeight(UiUtils.INSTANCE.dp2Px(getContext(), 50));
        this.setGravity(Gravity.CENTER_VERTICAL);
        this.setPadding(UiUtils.INSTANCE.dp2Px(getContext(), 12), UiUtils.INSTANCE.dp2Px(getContext(), 7), UiUtils.INSTANCE.dp2Px(getContext(), 12), UiUtils.INSTANCE.dp2Px(getContext(), 7));
