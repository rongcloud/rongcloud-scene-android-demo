 ...
 * 布局设置
 */
public class LivelayoutSettingFragment extends BaseFragment {


    private RecyclerView rcLayoutSetting;
    private LivelayoutSettingFragment.layoutAdapter layoutAdapter;
    private ArrayList<RCLiveMixType> rcLiveMixTypes;

    public LivelayoutSettingFragment() {
